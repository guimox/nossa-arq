    ...
    <>
      <section className="content-grid mt-20 space-y-20 py-20 text-zinc-700">
          ...
          {[0, 1, 2].map((index) => (
            <motion.div key={index} variants={fadeInUp}>
              <Paragraph>
                ...
                cupiditate soluta at ut ea recusandae officiis nisi magni enim
                facilis optio possimus alias tempora iure nemo. Blanditiis adipisci
                id unde! Nisi, ad aut eligendi placeat unde assumenda quia voluptate.
                Labore error cumque harum nemo rem iste quos temporibus, id eius
                ullam repellat possimus recusandae saepe dolore temporibus quaerat.
                Nulla. Quibusdam facere labore fugiat. Hic nihil ut consectetur illum
        ...
        >
          <div className="mx-auto flex w-full flex-col items-center gap-5 py-10 lg:flex-row lg:gap-20">
            ...
            <Paragraph className="w-full lg:w-3/4">
              ...
              Sapiente molestias ut cum magnam temporibus, enim harum sint? Quis
              minus cupiditate commodi illo, alias error aliquid. A reiciendis
              adipisci, nisi veniam, commodi libero repellendus sequi necessitatibus
              illum expedita facere exercitationem quis eveniet? Mollitia
              perspiciatis autem eos ratione ipsa.
            </Paragraph>
          </div>
        </motion.div>
        ...
        >
          <motion.div
            variants={fadeInUp}
            className="max-w-5xl space-y-4 text-justify"
          >
            <Heading>
              <Title>Desenho</Title>
            ...
            <Paragraph>
              ...
              nesciunt ut sunt ullam neque, sequi hic, facilis aperiam porro vel
              saepe reprehenderit tempore optio velit perferendis delectus, quo totam
